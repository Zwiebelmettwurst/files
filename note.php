...
if ($method === 'POST') {
    ...
    if ($note === '') {
        ...
        echo "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Note Created</title>";
        echo "<link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css' rel='stylesheet'></head><body>";
        echo "<div class='container' style='max-width:600px;margin-top:2em;'>";
        echo "<div class='alert alert-success'>Note created!</div>";
        echo "<div class='mb-3'><input type='text' class='form-control' value='" . htmlspecialchars($link) . "' readonly></div>";
        echo "<div class='text-center'><a href='/note' class='btn btn-secondary'>New note</a></div>";
        echo "</div></body></html>";
        exit;
    }
}
...
if ($token) {
    ...
    echo "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>View Note</title>";
    echo "<link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css' rel='stylesheet'></head><body>";
    echo "<div class='container' style='max-width:600px;margin-top:2em;'>";
    echo "<h2 class='mb-4 text-primary text-center'>Your Note</h2>";
    echo "<pre class='form-control' readonly style='white-space:pre-wrap;'>" . htmlspecialchars($note) . "</pre>";
    echo "<div class='alert alert-warning mt-3 text-center'>This note has been destroyed.</div>";
    echo "</div></body></html>";
    exit;
}
?>
